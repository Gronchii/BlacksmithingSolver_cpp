...
export module Blacksmithing:Game;

//convert to use shared_ptr instead of vector<Square*>?
...
namespace BlacksmithingGame {
	...
	public:
		...
		unsigned long long square_hash{ 0 };//hash of square based on location and type. will leave to user to set if wanted
		int hits_left{ 0};
		int id{ 0 };
		int row{ 0 };
		int col{ 0 };
